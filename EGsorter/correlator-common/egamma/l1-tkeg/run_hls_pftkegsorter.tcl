...
if { $pfBoard == "none" } {
    set funcs { "pftkegsorter_ele" "pftkegsorter_pho" }
} else {
    set funcs { "packed_pftkegsorter_ele" }
}
...
foreach func ${funcs} {
    ...
    add_files firmware/pftkegsorter.cpp -cflags "${cflags}"
    add_files -tb pftkegsorter_test.cpp -cflags "${cflags}"
    ...
    # Sim, synth, etc.
    csim_design -argv TTbar_PU200_${pfReg}.dump
