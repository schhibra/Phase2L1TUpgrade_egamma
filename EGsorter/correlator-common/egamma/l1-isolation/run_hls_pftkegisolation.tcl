...
if { $pfBoard == "none" } {
    set_top tkeg_tkisolation
} else {
    set_top packed_tkeg_tkisolation
}
add_files firmware/pftkegisolation.cpp -cflags "${cflags}"
add_files -tb pftkegisolation_test.cpp  -cflags "${cflags}"
add_files -tb ../l1-tkeg/ref/pftkegalgo_ref.cpp  -cflags "${cflags}"
