...
void calo_route_all_sectors_unpacked(const l1ct::HadCaloObj calo_in[NCALOSECTORS][NCALOFIBERS], l1ct::HadCaloObj fifo_in[NCALOSECTORS][NCALOFIFOS], bool fifo_write[NCALOSECTORS][NCALOFIFOS]) {
    ...
    const l1ct::glbeta_t hgc_eta_start = l1ct::Scales::makeGlbEtaRoundEven(1.5), hgc_eta_end = l1ct::Scales::makeGlbEtaRoundEven(3.0), hgc_eta_mid = (hgc_eta_start + hgc_eta_end)/2;
    const l1ct::glbeta_t reg_eta_start = l1ct::Scales::makeGlbEtaRoundEven(1.5), reg_eta_end = l1ct::Scales::makeGlbEtaRoundEven(2.5), reg_eta_mid = (reg_eta_start + reg_eta_end)/2;
    const l1ct::eta_t eta_shift = hgc_eta_mid - reg_eta_mid;
